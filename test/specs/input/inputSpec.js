describe('nemo input', function () {
    ...
    var formElement, fieldElement, scenarios = [
        ...
        { model: { "value": 'true',   "type": "checkbox" }, expectedType: 'checkbox',   expectedTag: 'input', expectedValue: true },
        { model: { "value": 'false',  "type": "checkbox" }, expectedType: 'checkbox',   expectedTag: 'input', expectedValue: false },
        { model: { "value": null,     "type": "checkbox" }, expectedType: 'checkbox',   expectedTag: 'input', expectedValue: false },
        { model: { "value": undefined,"type": "checkbox" }, expectedType: 'checkbox',   expectedTag: 'input', expectedValue: false },
        { model: {                    "type": "checkbox" }, expectedType: 'checkbox',   expectedTag: 'input', expectedValue: false },
        //Select
