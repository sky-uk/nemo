describe('app config', function () {
        ...
        it('must define the proper model and HTML structure for type "' + scenario.model.type + '"', function () {
            ...
            given(function () {
                formElement = compileDirective(
                    '<form name="foo" form-handler><nemo model="field"></nemo></form>',
    ...
    describe('error handling', function () {
        ...
        var scenarios = [
            { template: '<div name="foo" form-handler><nemo model="field"></nemo></div>', throwIfMessage: 'no parent form is found'},
            { template: '<form name="foo"><nemo model="field"></nemo></form>', expectation: 'no parent form handler is found'},
            { template: '<form form-handler><nemo model="field"></nemo></form>', expectation: 'no name attribute is found at the form level'},
            { template: '<form name="" form-handler><nemo model="field"></nemo></form>', expectation: 'an empty name attribute is found at the form level'}
        ];
